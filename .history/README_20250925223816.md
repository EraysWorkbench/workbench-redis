...
7. [Step 7 — Operational Commands (Full List)](#step-7--operational-commands-full-list)
8. [Step 8 — Laravel `.env` Examples (Copy-Paste)](#step-8--laravel-env-examples-copy-paste)
...
1) **Bridge IP** (Linux Docker default): `172.17.0.1`  
   Find it: `ip route | grep docker0` → look for `via 172.17.0.1`.
